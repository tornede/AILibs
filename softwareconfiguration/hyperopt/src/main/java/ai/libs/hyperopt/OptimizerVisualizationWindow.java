...
public class OptimizerVisualizationWindow implements Runnable {
	 ...
	 */
	public OptimizerVisualizationWindow(AlgorithmEventHistory algorithmEventHistory, IGUIPlugin mainPlugin, IGUIPlugin... visualizationPlugins) {
	 ...
	 * @param visualizationPlugins A list of additional {@link IGUIPlugin}s displaying side information.
	 */
	public OptimizerVisualizationWindow(ComponentInstanceEvaluator evaluator, List<AlgorithmEventPropertyComputer> algorithmEventPropertyComputers, IGUIPlugin mainPlugin, IGUIPlugin... visualizationPlugins) {
		this.mainPlugin = mainPlugin;
